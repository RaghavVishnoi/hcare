...
# ])
FirstAid.create!([
	{symptoms: 'Abdominal Pain',status: 'Active'},
	{symptoms: 'Animal Bites',status: 'Active' },
	{symptoms: 'Bee, Wasp, Insect Stings',status: 'Active' },	
	{symptoms: 'Blood in Urine (Hematuria)',status: 'Active' },	
	{symptoms: 'Broken Toe',status: 'Active' },	
	{symptoms: 'Bruises (Hematomas)',status: 'Active' },	
	{symptoms: 'Burns',status: 'Active' },	
	{symptoms: 'Choking',status: 'Active' },	
	{symptoms: 'Cuts and Wounds',status: 'Active' },	 		
	{symptoms: 'Diarrhea',status: 'Active' },	
	{symptoms: 'Dizziness',status: 'Active' },	
	{symptoms: 'Fever in Children',status: 'Active' },	
	{symptoms: 'Food Poisoning',status: 'Active' },	
	{symptoms: 'Frostbite',status: 'Active' },	
	{symptoms: 'Heart Palpitations',status: 'Active' },
	{symptoms: 'Heat Exhaustion',status: 'Active' },
	{symptoms: 'Heatstroke',status: 'Active' },	
	{symptoms: 'Hypothermia',status: 'Active' },
	{symptoms: 'Nosebleeds',status: 'Active'},	
	{symptoms: 'Pulled Muscle (Muscle Strain)',status: 'Active' },
	{symptoms: 'Rectal (Anal) Bleeding',status: 'Active' },	
	{symptoms: 'Spider Bites',status: 'Active' },	
	{symptoms: 'Sprains',status: 'Active' },	
	{symptoms: 'Sunburn',status: 'Active' },
    {symptoms: 'Testicle Pain',status: 'Active' },	
    {symptoms: 'Vertigo',status: 'Active' }		
